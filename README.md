...
Aim to begin top-level documentation (e.g. `./README.md`) with a short summary/introduction describing the goal or purpose of the codebase in as close to layman's terms as possible.
